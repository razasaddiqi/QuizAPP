...
class QuizBrain {
  ...
  List<Question> _questionBank = [
    ...
    Question('Which of the following used for hybrid app development?',["Ionic","Flutter","React Native","All above"], 4),
    Question('What is the correct way to define Text in flutter?',["Text('Some value')","text()","TEXT(hello)","Text(somevalue)"], 1),
    Question('A notable feature of the Dart platform is its support for "hot reload"',["True","False"], 1),
    Question('Which of the following cannot be build in flutter?',["Web","IOS","Android","None of the Above"], 4),
    Question('What is the latest version of flutter',["1.25.4","1.22.9","1.22.4","1.22.3"], 3)
  ...
  List<Widget> getallquestion(List<int> wrongans,int type){
    ...
    for(int i=0; i<wrongans.length;i++) {
      ...
      if (t != -10) {
        if (i == 0 && type == 0) {
          temp.add(Text("Wrong Answers", style: TextStyle(fontSize: 30,
              color: Colors.black,
              fontWeight: FontWeight.bold),));
        }
        else if (i == 0 && type == 1) {
          temp.add(Text("Correct Answers", style: TextStyle(fontSize: 30,
              color: Colors.black,
              fontWeight: FontWeight.bold),));
        }
        temp.add(
            Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(_questionBank[t].questionText, style: TextStyle(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text("Answer: ", style: TextStyle(
                            fontSize: 20, fontWeight: FontWeight.bold),),
                        Text(_questionBank[t].data[_questionBank[t].index - 1],
